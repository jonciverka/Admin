  ...
  class seispuntouno extends React.Component {
    render() {
      return (        
        ...
        />
        <ScrollView>
         <View style={styles.containerr, {height: 2630}}>
  ...
  class seispuntodos extends React.Component {
    render() {
      return (        
        ...
        />
        <ScrollView>
         <View style={styles.containerr, {height: 1785}}>
          <View style={styles.titulo}> 
  ...
  class seispuntotres extends React.Component {
    render() {
      return (        
        ...
        />
        <ScrollView>
         <View style={styles.containerr, {height: 7000}}>
          <View style={styles.titulo}> 
          ...
          <WebView
            source={{
              ...
              "<style>p{text-align:justify}</style>"+
              "<p>"+
              "Aplica tus conocimientos y realiza la siguiente evidencia de aprendizaje:"+
              "</p>"
           }}
          />
          </View>
          ...
          <View style={styles.containerr, {height: 105}}>  
          <WebView
            source={{
              html:
              "<style>p{text-align:justify}</style>"+
          ...
          <View style={styles.containerr, {height: 600}}>  
            <WebView
              source={{
                html:
                "<style>p{text-align:justify}</style>"+
          ...
          <View style={styles.containerr, {height: 50}}>  
            <WebView
              source={{
                ...
                "<style>p{text-align:justify}</style>"+
                "<p>"+
                "Después de haber leído el material anterior realiza la siguiente evidencia de aprendizaje:"+  
                "</p>" 
              }}
            />
          </View>
  ...
  class seispuntocuatro extends React.Component {
    render() {
      return (        
        ...
        />
        <ScrollView>
         <View style={styles.containerr, {height: 11200}}>
          <View style={styles.titulo}> 
           <Text><H1>Punto de equilibrio</H1></Text>          
          </View>
          <View style={styles.containerr, {height: 235}}>
          <WebView
            source={{
              html:
              "<style>p{text-align:justify}</style>"+
          ...
          />
           ...
           <Image
            ...
            resizeMode = 'stretch'
          />
          <View style={styles.containerr, {height: 55}}>
          <WebView
            source={{
              html:
              "<style>p{text-align:justify}</style>"+
          ...
          <View style={styles.containerr, {height: 265}}>  
          <WebView
            source={{
              html:
              "<style>p{text-align:justify}</style>"+
          ...
          <Image
            ...
            resizeMode = 'stretch'
          />
          <View style={styles.containerr, {height: 285}}>  
          <WebView
            source={{
              html:
              "<style>p{text-align:justify}</style>"+
          ...
          <View style={styles.containerr, {height: 55}}>  
            <WebView
              source={{
                ...
                "<style>p{text-align:justify}</style>"+
                "<p>"+
                "Para una mayor comprensión de este tema resuelve la siguiente evidencia de aprendizaje:"+ 
                "</p>" 
              }}
            />
          </View>
          ...
          <Image
            style = {[styles.imagenes,{height:65}]}
          ...
          <View style={styles.containerr, {height: 560}}>  
            <WebView
              source={{
                html:
                "<style>p{text-align:justify}</style>"+
          ...
          <View style={styles.containerr, {height: 635}}>  
            <WebView
              source={{
                html:
                "<style>p{text-align:justify}</style>"+
...
class seispuntocinco extends React.Component {
    render() {
      return (        
        ...
        />
        <ScrollView>
         <View style={styles.containerr, {height: 3640}}>
          <View style={styles.titulo}> 
          ...
          <View style={styles.containerr, {height: 380}}>
          <WebView
            source={{
              html:
              "<style>p{text-align:justify}</style>"+
          ...
          <View style={styles.containerr, {height: 550}}>
          <WebView
            source={{
              html:
              "<style>p{text-align:justify}</style>"+
  ...
  class seispuntoseis extends React.Component {
    render() {
      return (        
        ...
        />
        <ScrollView>
         <View style={styles.containerr, {height: 4160}}>
          <View style={styles.titulo}> 
          ...
          <View style={styles.containerr, {height: 675}}>
          <WebView
            source={{
              html:
              "<style>p{text-align:justify}</style>"+
