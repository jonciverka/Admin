  ...
  class dospuntouno extends React.Component {
    render() {
      return (        
        ...
        />
        <ScrollView>
         <View style={styles.containerr, {height: 2940}}>
          <View style={styles.titulo}> 
            <Text><H1>Estudio de mercado</H1></Text>          
          </View>
          <View style={styles.containerr, {height: 440}}>
          <WebView
            source={{
              html:
  ...
  class dospuntodos extends React.Component {
    render() {
      return (
        <Container style={styles.fondo}>
          <ScrollView>
         <View style={styles.containerr, {height: 2265}}>
          <View style={styles.titulo}> 
            <Text><H1>Segmentación del mercado </H1></Text>          
          </View>
          <View style={styles.containerr, {height: 225}}>
          <WebView
            source={{
              html:
              "<style>p{text-align:justify}</style>"+
  ...
  class dospuntotres extends React.Component {
    render() {
      return (
        <Container style={styles.fondo}>
          <ScrollView>
         <View style={styles.containerr, {height: 8940}}>
          <View style={styles.titulo}> 
  ...
  class dospuntocuatro extends React.Component {
    render() {
      return (
        <Container style={styles.fondo}>
          <ScrollView>
         <View style={styles.containerr, {height: 11510}}>
          <View style={styles.titulo}> 
          ...
          <Image
            ...
            resizeMode = 'stretch'
          />
          <View style={styles.containerr, {height: 830}}>
            <WebView
              source={{
                html:
                "<style>p{text-align:justify}</style>"+
  ...
  class dospuntocinco extends React.Component {
    render() {
      return (
        <Container style={styles.fondo}>
          <ScrollView>
         <View style={styles.containerr, {height: 5910}}>
          <View style={styles.titulo}> 
          ...
          <View style={styles.containerr, {height: 325}}>
            <WebView
              source={{
                html:
                "<style>p{text-align:justify}</style>"+
          ...
          <Image
            ...
            resizeMode = 'stretch'
          />
          <View style={styles.containerr, {height: 610}}>
            <WebView
              source={{
                html:
                "<style>p{text-align:justify}</style>"+
                ...
                "</p>"+
                "<p>"+
                "Conoce más acerca de las mercancías que importa México en:"+
                "</p>"+
                "<p>"+
          ...
          <Image
            ...
            resizeMode = 'stretch'
          />
          <View style={styles.containerr, {height: 175}}>
            <WebView
              source={{
                html:
                "<style>p{text-align:justify}</style>"+
         ...
         <Image
          ...
          <Image
            ...
            resizeMode = 'stretch'
          />
          <View style={styles.containerr, {height: 720}}>
            <WebView
              source={{
                html:
                "<style>p{text-align:justify}</style>"+
  ...
  class dospuntoseis extends React.Component {
    render() {
      return (
        <Container style={styles.fondo}>
          <ScrollView>
         <View style={styles.containerr, {height: 2435}}>
          <View style={styles.titulo}> 
