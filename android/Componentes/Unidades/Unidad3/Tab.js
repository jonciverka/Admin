...
class trespuntouno extends React.Component {
    ...
    <Container style={styles.fondo}>
          ...
          <ScrollView>
           <View style={styles.containerr, {height: 520}}>
...
class trespuntodos extends React.Component {
  ...
  <Container style={styles.fondo}>
          ...
          <ScrollView>
           <View style={styles.containerr, {height: 2590}}>
            <View style={styles.titulo}>  
            ...
            <View style={styles.containerr, {height: 50}}>
              <WebView
                source={{
                  ...
                  "<style>p{text-align:justify}</style>"+
                  "<p>"+
                  "Imagen 3.7. Fuente: Elaboración propia"+
                  "</p>" 
               }}
              />
            </View>
...
class trespuntotres extends React.Component {
	...
	<Container style={styles.fondo}>
          ...
          <ScrollView>
           <View style={styles.containerr, {height: 4530}}>
            <View style={styles.titulo}>  
            ...
            <Image
              ...
              source={require('../../../images/Unidad3/tabla6.png')}
              resizeMode = 'stretch'
            />
